...
//google maps location
        try {
          URL url = new URL ("https://www.google.com/maps/dir/?api=1" + "?");
          URLConnection connection = url.openConnection();
          connection.connect();
          bot("Here are some results for you");
java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.google.com/maps/dir/?api=1"
							+ message.replace(" ", "+") + "&btnG=Google+Search"));
        } catch (Exception ee) {
					bot("Connect with internet connection for get better results...");
				}
...
// google translate
      try {
          URL url = new URL ("https://google-translate1.p.rapidapi.com/language/translate/v2/detect" + "?");
          URLConnection connection = url.openConnection();
          connection.connect();
          bot("Here are some results for you");
java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://google-translate1.p.rapidapi.com/language/translate/v2/detect"
							+ message.replace(" ", "+") + "&btnG=Google+Search"));
        } catch (Exception ee) {
					bot("Connect with internet connection for get better results...");
				}
